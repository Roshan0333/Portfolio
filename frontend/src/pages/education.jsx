...
export function Education() {
    ...
    return (
            <div className="relative flex flex-col items-center justify-center gap-4 w-[98%] md:w-[80%] mx-auto p-5">
                <div className="absolute top-0 bottom-0 left-[45px] md:left-[60px] lg:left-[65px] w-[2px] 
    bg-gradient-to-b from-[#7C3AED] via-[#8B5CF6] to-[#C4B5FD] animate-[pulseGlow_2s_infinite]">
                </div>
